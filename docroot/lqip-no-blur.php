...
<head>
  ...
  <title>LQIP No Blur (2-level)</title>
...
<body>
  <?php $currentPage = 'lqip-no-blur.php'; include 'includes/nav.php'; ?>
  ...
  <div class="container">
    <h1>LQIP No Blur (2-level)</h1>
    <p>This page demonstrates the two-level LQIP technique: a tiny base64 placeholder, then a display-size LQIP-LCP image at 0.055 BPP, then the full-res image.</p>
    <ul>
