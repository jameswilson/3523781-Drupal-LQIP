...
<head>
  ...
  <meta name="description" content="This page demonstrates a baseline lazy-loaded JPG hero image.">
</head>

<body>
  <?php $currentPage = basename(__FILE__);
  include 'includes/nav.php'; ?>
  <div class="hero-wrapper hero-wrapper--baseline-lazy">
    <img
      class="hero-hi-res hero-hi-res--baseline-lazy"
      width="1200"
      height="675"
      src="<?= $hero_url ?>"
      alt="Hero"
